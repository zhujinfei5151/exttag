...
public abstract class AbstractTag extends BodyTagSupport {
	...
	protected final String getUniqueClassName() {
		...
		super.pageContext.setAttribute(UNIQUE_NAME_KEY, unique,
	...
	protected final void defineComponent(String component) {
		getComponentBuffer().append("  " + component);
	}
	...
	protected final void defineBeforeScript(String script) {
		getBeforeScriptBuffer().append(" " + script);
	}
	...
	protected final void defineAfterScript(String script) {
		getAfterScriptBuffer().append(" " + script);
	}
	...
	private final Map<String, String> getStatus() {
		Map<String, String> status = (Map<String, String>) super.pageContext
				.getAttribute(STATUS_KEY, PageContext.PAGE_SCOPE);
		if (status == null) {
