...
public class ScriptTagProxy extends DataProxy {
	...
	@Description("callbackParam : String  (Optional) The name of the parameter to pass to the server which tells the server the name of the callback function set up by the load call to process the returned data object. Defaults to 'callback'."
	...
	@Description("nocache : Boolean  (Optional) Defaults to true. Disable cacheing by adding a unique parameter name to the request. ")
	...
	@Description("timeout : Number  (Optional) The number of milliseconds to wait for a response. Defaults to 30 seconds. ")
	...
	@Description("url : String   The URL from which to request the data object. ")
