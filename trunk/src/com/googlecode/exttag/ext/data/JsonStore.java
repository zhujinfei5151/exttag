...
public class JsonStore extends Store {
	...
	@Description("fields : Array  Either an Array of field definition objects as passed to Ext.data.Record.create, or a Record constructor created using Ext.data.Record.create. ")
	...
	@Description("root : String   json list root")
