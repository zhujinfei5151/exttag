...
public class Connection extends Observable {
	...
	@Description("autoAbort : Boolean  (Optional) Whether this request should abort any pending requests. (defaults to false) ")
	...
	@Description("defaultHeaders : Object  (Optional) An object containing request headers which are added to each request made by this object. (defaults to undefined) ")
	...
	@Description("disableCaching : Boolean  (Optional) True to add a unique cache-buster param to GET requests. (defaults to true) ")
	...
	@Description("extraParams : Object  (Optional) An object containing properties which are used as extra parameters to each request made by this object. (defaults to undefined) ")
	...
	@Description("method : String  (Optional) The default HTTP method to be used for requests. (defaults to undefined; if not set but parms are present will use POST, otherwise GET)")
	...
	@Description("timeout : Number (Optional) The timeout in milliseconds to be used for requests. (defaults to 30000) ")
	...
	@Description("url : String  (Optional) The default URL to be used for requests to the server. (defaults to undefined) ")
